...
![](<.gitbook/assets/5 (5).png>)If the jumper is ON (the jumper link is inserted connecting the two pins), Terminal 1 is

set to Roller Shutter connection

![](<.gitbook/assets/6 (4).png>)If the jumper is OFF ( if the jumper link is removed or “**parked**” on one pin), Terminal 1 is
...
![](<.gitbook/assets/7 (6).png>)If the jumper is ON, when the Terminal 2 counts **5** Pulses **in 10 seconds**, the Door Contact will send

alarm signal.

![](<.gitbook/assets/8 (7).png>)If the jumper is OFF, the Terminal 2 will not be triggered by 5 Pulses in 10 seconds. _(**Factory Default**)_
...
![](<.gitbook/assets/9 (8).png>)If the jumper is ON, when the Terminal 2 counts **6** Pulses **in 10 seconds**, the Door Contact will send

alarm signal.

![](<.gitbook/assets/10 (8).png>)If the jumper is OFF, the Terminal 2 will not be triggered by 6 Pulses in 10 seconds. _(**Factory Default**)_
...
![](<.gitbook/assets/11 (5).png>)If the jumper is ON, when the Terminal 2 counts **8** Pulses **in 10 seconds**, the Door Contact will send

alarm signal.

![](<.gitbook/assets/12 (9).png>)If the jumper is OFF, the Terminal 2 will not be triggered by 8 Pulses in 10 seconds. _(**Factory Default**)_
...
![](<.gitbook/assets/13 (9).png>) ![](<.gitbook/assets/14 (8).png>)
