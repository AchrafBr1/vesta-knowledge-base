...
* Low Battery status ( ![](<.gitbook/assets/image (1).png>)icon).
...
* ![](<.gitbook/assets/image (1) (1).png>) If the jumper link is inserted between the top 2 pins, the LCD will display the temperature in Celsius. (**Factory Default**)
