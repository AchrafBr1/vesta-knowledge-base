...
| **Component**           | **Behavior**                                                                    | **Function/Indication**                       | **Charging & Programming Cradle (CT-29)** |   |   |
| ----------------------- | ------------------------------------------------------------------------------- | --------------------------------------------- | ----------------------------------------- | - | - |
| **Active Button**       | Press and hold for 20 seconds                                                   | - To turn on the unit (exits airplane mode).  |                                           |   |   |
|                         |                                                                                 |                                               |                                           |   |   |
|                         |                                                                                 | - To turn off the unit (enters airplane mode) |                                           |   |   |
|                         | Press once                                                                      | Trigger emergency alarm                       |                                           |   |   |
|                         | Press and hold for 5 seconds during a                                           | Cancel alarm                                  |                                           |   |   |
|                         | Guard Time                                                                      |                                               |                                           |   |   |
|                         | Press once when Mobile Lite is ringing                                          | Pick up incoming call                         |                                           |   |   |
|                         | Press and hold for 5 seconds during a                                           | Terminate the call                            |                                           |   |   |
|                         | call                                                                            |                                               |                                           |   |   |
...
| **Top LED (Green)**     | On                                                                              | Charging                                      |                                           |   |   |
| 1 flash every 5 seconds | Normal Operation                                                                |                                               |                                           |   |   |
|                         |                                                                                 |                                               |                                           |   |   |
| **Top LED (Red)**       | 1 Flash every 3 seconds                                                         | Low Battery                                   |                                           |   |   |
|                         | When Mobile Lite is charging, the Red LED will not indicate the battery status. | Charging & Programming                        | Micro USB Jack                            |   |   |
...
| **Belt Clip Attachment**          | **Belt Clip Removal**                |   |   |   |
| --------------------------------- | ------------------------------------ | - | - | - |
|                                   |                                      |   |   |   |
| Hook the the belt clip onto the   | Press the button to remove the clip. |   |   |   |
...
| Mobile Lite can be programmed via USB port connection of a computer using     | _https://www.climax.com.tw/climax-download-mobile-lite-r29.html_ |   |   |
| ----------------------------------------------------------------------------- | ---------------------------------------------------------------- | - | - |
...
| ● Make sure Mobile Lite is connected properly. (Please refer to 4.3.          |                                                                  |   |   |
| Installation for Programming.)                                                |                                                                  |   |   |
| ● Go to http://www.ftdichip.com/Drivers/VCP.htm. Select the driver file       |                                                                  |   |   |
| according to your operating system, download and install USB driver.          |                                                                  |   |   |
| ● After installing the driver, unzip the file to a desired folder and execute |                                                                  |   |   |
| the “Mobile\_Tool.exe” file.                                                  |                                                                  |   |   |
| ● For more details about the programming tool, please download                |                                                                  |   |   |
