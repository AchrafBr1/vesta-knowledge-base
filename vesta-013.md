...
After the battery has been removed, press the Learn / Test button 5-6 times to fully discharge it before inserting the new battery.

{% hint style="warning" %}
Note:

Make sure the battery mark with the positive side (+) is facing upward when inserting the battery.
...
Step 3: Press the Learn/Test Button on the Door Contact to send signal to the Control Panel.
...
Step 4. Once the cover is open, you can proceed to change the battery etc.

Step 5. To replace the cover:

\- Make sure the Tamper Compression Mark is aimed at the Tamper Switch (**Pic 3**).

\- Also, make sure the bottom hooks of the back cover are latched on the bottom of the front cover (back) as (**Pic 4**)
...
<figure><img src=".gitbook/assets/2025-04-01 22_08_00-VESTA-013 MDC-3.pdf - Foxit PDF Reader.png" alt=""><figcaption></figcaption></figure>
...
&#x20;The back cover has two Mounting Holes (knockouts), where the plastic is thinner, for mounting purposes.
...
&#x20;      The Door Contact can be wall-mounted using the Velcro tape provided.

1. Clean the wall mounting location and back of the Door Contact with a degreaser. Do not mount it on the wall with cracking paint or a rough surface.
...
The back cover of the magnet has two Mounting Holes for mounting purposes.
