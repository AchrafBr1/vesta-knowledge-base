...
<mark style="color:orange;">**Étape 5**</mark>. Appuyez sur la touche <img src=".gitbook/assets/image (2) (1) (1) (1) (1).png" alt="" data-size="line"> **deux fois** pour quitter le mode Test et l'installation est terminée. Le clavier émettra un long bip et les trois LED de mode système s'éteindront. Le clavier revient au mode de fonctionnement normal.
...
* **Armement Total:** Saisir un code utilisateur et appuyer sur la touche <img src=".gitbook/assets/image (3) (1) (1) (1).png" alt="" data-size="line">. Si aucun défaut n'est détecté et que l'armement est réalisé, la LED <img src=".gitbook/assets/image (4) (1) (1).png" alt="" data-size="line"> s'allumera accompagnée d'un bip long.
...
* **Armement Total:** Appuyez sur la touche <img src=".gitbook/assets/image (3) (1) (1) (1).png" alt="" data-size="line">. Si aucun défaut n'est détecté et que l'armement est réalisé, la LED <img src=".gitbook/assets/image (4) (1) (1).png" alt="" data-size="line"> s'allumera accompagnée d'un bip long.
