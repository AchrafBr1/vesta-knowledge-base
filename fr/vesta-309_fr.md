...
-   -   Mettez la passerelle Z-Wave ou le panneau de commande dans**Mode d'inclusion**(veuillez vous référer au manuel de la passerelle Z-Wave ou du panneau de commande).
    ...
    -   La passerelle inclura automatiquement l'appareil lors de la reconnaissance de l'appareil en faisant correspondre la demande d'inclusion avec le DSK obtenu
        ...
        -   Si l'appareil a déjà été ajouté (inclus) dans une autre passerelle/panneau de commande Z-Wave, veuillez d'abord l'exclure (voir_**Suppression d'un périphérique**_) avant d'essayer de l'inclure dans la passerelle/panneau de configuration Z-Wave actuel. L'appareil n'enverra pas de message
...
Batterie CC (COMMANDE_CLASSE_BATTERIE)

SensorMutilevel CC, V11 (COMMANDE_CLASSE_CAPTEUR_MULTINIVEAU)

Notification CC,V8 (COMMANDE_CLASSE_NOTIFICATION)
...
Activation de scène CC (COMMANDE_CLASSE_SCÈNE_ACTIVATION)
...
Prière de se référer à_Tableau 2_Siren Control, il enverra 00 00 lorsque le détecteur de fumée sera restauré.

-   _**Format de données de classe de commande**_
    -   **Panne/Rétablissement CA :\[COMMANDE_CLASSE_NOTIFICATION]\[NOTIFICATION_RAPPORT]**
...
-   **Batterie:\[COMMANDE_CLASSE_BATTERIE]\[BATTERIE_RAPPORT]**
...
-   **Rapport de température/humidité :\[COMMANDE_CLASSE_CAPTEUR_MULTINIVEAUX]\[CAPTEUR_MULTINIVEAUX_RAPPORT]**
...
-   **Test du détecteur de fumée/Test du détecteur de fumée désactivé : \[COMMANDE_CLASSE_NOTIFICATION]\[NOTIFICATION_RAPPORT]**
...
-   **Urgence de fumée/Urgence de fumée résolue :\[COMMANDE_CLASSE_NOTIFICATION]\[NOTIFICATION_RAPPORT]**
...
-   **Urgence de chaleur/Urgence de chaleur résolue :\[COMMANDE_CLASSE_NOTIFICATION]\[NOTIFICATION_RAPPORT]**
...
-   **Urgence CO/Urgence CO résolue :\[COMMANDE_CLASSE_NOTIFICATION]\[NOTIFICATION_RAPPORT]**
...
-   **Rapport d'ouverture/fermeture de sabotage :\[COMMANDE_CLASSE_NOTIFICATION]\[NOTIFICATION_RAPPORT]**
...
|  Fermeture anti-sabotage : | 00 00 00FF 07 00 01 03 |
| --------------------------- | ---------------------- |
...
-   **Contrôle scène/sirène :\[COMMANDE_CLASSE_SCÈNE_ACTIVATION]\[SCÈNE_ACTIVATION_SET] (pour les modèles connectés en série) :**
...
-   **Commande marche/arrêt de la sirène :\[COMMANDE_CLASSE_BASIQUE]\[BASIQUE_ENSEMBLE]**
    ...
    -   **Indicateur**Contrôle**:\[COMMANDE_CLASSE_INDICATEUR]\[INDICATEUR_ENSEMBLE]**
...
| - | - | ------- | - | ------------------------------------------------------------------------ | ------------------------------ | --------------- | - | - | - | - | - | - |
|   |   |         |   |                                                                          |                                |                 |   |   |   |   |   |   |
|   |   |         |   | Classe de commande = COMMANDE_CLASSE_INDICATEUR                          |                                |                 |   |   |   |   |   |   |
|   |   |         |   |                                                                          |                                |                 |   |   |   |   |   |   |
|   |   |         |   |                                                                          | Commande = INDICATEUR_ENSEMBLE |                 |   |   |   |   |   |   |
|   |   |         |   |                                                                          |                                |                 |   |   |   |   |   |   |
...
|   |                    |   |   |                    |   |                                                    |                          |   |   |
|   |                    |   |   |                    |   |                                                    |                          |   |   |
|   | 0x43               |   |   | BOUTON1_INDICATION |   | Utilisez pour attirer l’attention sur le bouton 1. |                          |   |   |
...
|                                                            |   |                    |   |   |                    |                      |                                                   |                          |                                                               |                        |   |   |   |
|                                                            |   |                    |   |   |                    |                      |                                                   |                          |                                                               |                        |   |   |   |
|                                                            |   | 0x44               |   |   | BOUTON2_INDICATION |                      | Utiliser pour attirer l'attention sur le bouton 2 |                          |                                                               |                        |   |   |   |
|  ID de propriété (0x00-0xFE) --- LED allumée_temps libres |   |                    |   |   |                    |                      |                                                   |                          |                                                               |                        |   |   |   |
|                                                            |   | Valeur             |   |   |                    | Description générale |                                                   |                          |                                                               | Utilisation spécifique |   |   |   |
|                                                            |   | 0x04               |   |   |                    | Sur_Désactivé_Cycles | Nombre de activés_Désactivé_Période à courir      |                          |                                                               |                        |   |   |   |
|                                                            |   |                    |   |   |                    |                      |                                                   |                          | 0x00 – 0xFE = 0 à 254 fois                                    |                        |   |   |   |
|                                                            |   |                    |   |   |                    |                      |                                                   |                          | 0xFF = Exécuter jusqu'à ce qu'il soit arrêté par On_Désactivé |                        |   |   |   |
|                                                            |   |                    |   |   |                    |                      |                                                   |                          |                                                               |                        |   |   |   |
...
**Configurations :\[COMMANDE_CLASSE_CONFIGURATION]\[CONFIGURATION_ENSEMBLE]**
...
| (prière de se référer à_Tableau 3_)    |                                        |
|                                        |                                        |
