...
Pour mettre le capteur de mouvement en mode test constant, veuillez régler le commutateur DIP 1 (veuillez vous référer à\_Tableau de position des commutateurs DIP\_).
