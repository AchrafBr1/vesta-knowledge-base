...
-   VST-892
-   Introduction
-   Modèle : VESTA-245<https://bydemes.com/es/productos/intrusion/alarma-vesta/detectores/VESTA-245>
...
4.  ![](<.gitbook/assets/1 (1) (1) (1) (1).png>)**Interrupteur anti-sabotage**
...
-   ![](<.gitbook/assets/5 (9).png>)Évitez les gros obstacles dans la zone de détection.
...
5.  ![triangular bracket](<.gitbook/assets/6 (8).jpeg>)![](<.gitbook/assets/7 (7).png>)Fixez la caméra PIR sur les crochets du support triangulaire.
...
3.  Utilisez les trous comme gabarit pour percer des trous sur la surface.
4.  ![](<.gitbook/assets/8 (8).png>)Insérez les chevilles murales si vous le fixez dans du plâtre ou de la brique.
5.  Vissez la base dans les chevilles murales.
6.  Installez le couvercle sur la base et serrez.
