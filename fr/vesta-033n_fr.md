...
VII. Fixez le couvercle avec la vis et les clips à la base
...
Commencez s'il vous plaît_**Apprentissage**_la balise dans le panneau de configuration, suivez les étapes ci-dessous :
...
Commencer_**Suppression**_le tag à partir du Tag Reader, suivez les étapes ci-dessous :

(_Veuillez vous assurer de déjà quitter le mode d'apprentissage_)
