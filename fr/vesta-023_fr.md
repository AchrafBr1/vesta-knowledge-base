...
1. Appuyez une fois sur le bouton Apprendre/Test pour transmettre un code d'apprentissage.
...
* _Interconnexion_\_(SD-29-HME-SC uniquement)\_
...
* ![100-2](<.gitbook/assets/3 (12).png>)À proximité d'un ventilateur, d'une lampe fluorescente ou d'un équipement de climatisation – les courants d'air qui en proviennent peuvent affecter la sensibilité du détecteur.
