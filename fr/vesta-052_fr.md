...
Lorsque le PIR détecte un mouvement, il transmet un signal de déclenchement. Le PIR commence alors le décompte du minuteur d'occupation/vacance. La durée de la minuterie est réglable de**30 secondes**à**60 minutes**et doit être réglé à partir du coordinateur/panneau de contrôle du réseau Z-Wave.
