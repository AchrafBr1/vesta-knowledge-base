...
1.  ![](<.gitbook/assets/2 (57).jpeg>)**SUR**lorsque l'appareil est déjà appris dans le réseau Zig-Bee.
...
\-![](<.gitbook/assets/9 (25).jpeg>)Appuyez sur ce bouton pour changer instantanément les températures diurnes et nocturnes.

_**Jour par défaut**_![](<.gitbook/assets/10 (19).jpeg>)_température: 21_°C_,**Nuit par défaut**_![](<.gitbook/assets/11 (24).jpeg>)_température: 17_°C
...
| **/ Facultatif**                |                                         |                               |                                        |             |            |                 |   |
|                                 |                                         |                               |                                        |             |            |                 |   |
| 0x0000                          | _LOCALE_TEMPÉRATURE_                    | 16 bits                       | 0x954d – 0x7fff                        | Lire        | 0x0000     | M.              |   |
| seulement                       |                                         |                               |                                        |             |            |                 |   |
|                                 |                                         |                               |                                        |             |            |                 |   |
| 0x0003                          | _MINIMUM_CHALEUR_POINT DE CONSIGNE_QUE_ | 16 bits                       | 0x954d – 0x7fff                        | Lire        | 0x01F4     | Ô               |   |
| _AVEC_                          | seulement                               |                               |                                        |             |            |                 |   |
|                                 |                                         |                               |                                        |             |            |                 |   |
| 0x0004                          | _MAXIMUM_CHALEUR_POINT DE CONSIGNE_QUE_ | 16 bits                       | 0x954d – 0x7fff                        | Lire        | 0x0DAC     | Ô               |   |
| _AVEC_                          | seulement                               |                               |                                        |             |            |                 |   |
|                                 |                                         |                               |                                        |             |            |                 |   |
|                                 | _OCCUPÉ_CHAUFFAGE_ENSEMBLE_             |                               | _Point de consigne de chaleur minimum_ | Lire /      |            |                 |   |
| 0x0012                          | 16 bits                                 | _Limite_–_Chaleur maximale_   | 0x07D0                                 | M.          |            |                 |   |
| _INDIQUER_                      | Écrire                                  |                               |                                        |             |            |                 |   |
|                                 |                                         | _Limite du point de consigne_ |                                        |             |            |                 |   |
|                                 |                                         |                               |                                        |             |            |                 |   |
| 0x001B                          | _CTRL_SEQ_DE_OPÉRATEUR_                 | 8 bits                        | 0x00 – 0x05                            | Lire /      | 0x04       | M.              |   |
| Énumération                     | Écrire                                  |                               |                                        |             |            |                 |   |
|                                 |                                         |                               |                                        |             |            |                 |   |
