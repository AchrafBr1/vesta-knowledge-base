...
* ![852Pro R8\_20160629](<.gitbook/assets/0 (1) (1) (1).jpeg>)Identification des pièces
...
* Appuyez et maintenez le bouton de fonction pendant 3 secondes, relâchez le bouton lorsque la LED bleue s'allume. (Pour le panneau fonctionnant sur batterie, après avoir appuyé et maintenu enfoncé le bouton de fonction pendant 3 secondes, veuillez appuyer sur le bouton de fonction**encore** for one second.)
...
* ![852 r3 knockouts](<.gitbook/assets/6 (3) (1).jpeg>)_Montage de la caméra PIR_
...
1. ![triangular bracket](<.gitbook/assets/7 (1) (1).jpeg>)![triangular bracket](<.gitbook/assets/8 (1) (1) (1).jpeg>)Ouvrez le couvercle en desserrant la vis du couvercle à l'aide d'un tournevis Philips.
