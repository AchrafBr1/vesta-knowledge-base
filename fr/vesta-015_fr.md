...
3. **Cavalier d'augmentation de sensibilité (JP3)**\
   ...
   \- Cavalier On : le niveau de sensibilité du PIR est réglé sur Haut. <img src=".gitbook/assets/image (2) (1).png" alt="" data-size="line">\
   \- Cavalier Off : le niveau de sensibilité du PIR est réglé sur Normal (**par défaut**). <img src=".gitbook/assets/image (1) (1) (1).png" alt="" data-size="line">
4. **Autoprotection**\
