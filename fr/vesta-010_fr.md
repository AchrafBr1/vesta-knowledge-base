...
* Lorsque le sabotage du clavier est déclenché, il enverra un signal de défaut de sabotage KP au panneau de commande et la LED orange de défaut s'allumera. De plus, lors de l'utilisation du clavier, la LED Orange Fault restera allumée pour indiquer le défaut de sabotage KP.
...
* Pour quitter le mode Test, appuyez sur![](<.gitbook/assets/5 (5).png>)**deux fois**, Le clavier émettra un long bip et la LED verte active s'allumera, puis le clavier reviendra en mode de fonctionnement normal.
  ...
  *
    *
      *
        ...
        * Quitter le mode test : appuyez sur![](<.gitbook/assets/6 (1).png>)**deux fois**.
...
2. Appuyez ensuite sur la touche ＊**1** key. Remote keypad will sound one beep.
...
Step 6. Press ![](<.gitbook/assets/7 (2).png>)**deux fois**pour quitter le mode Test et l'installation est terminée.
