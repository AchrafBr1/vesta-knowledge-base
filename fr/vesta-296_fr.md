...
*
  ...
  2. Lorsque toutes les actions sont terminées, le contrôle d'obturation enverra un message MULTILEVEL\_RAPPORT : 0x63 au contrôleur indiquant que la position actuelle est en haut. La LED s'éteindra lorsque le moteur d'obturation quittera le mode d'étalonnage automatique.
