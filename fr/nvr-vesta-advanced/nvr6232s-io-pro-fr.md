...
<figure><img src="../.gitbook/assets/image (1) (1) (1).png" alt="" width="375"><figcaption><p>NVR6232S-IO-PRO</p></figcaption></figure>
...
* Bande passante: 256 Mbps in, 256 Mbps out
* Capacité de décodage:
  * 4 canal en 8MP (30 fps)
  * 16 canaux en 1080P (30 fps)
...
* IA depuis l'enregistreur
  * Protection périmétrique (zone, ligne) jusqu'à 2 canaux
  * Détection de visage jusqu'à 2 canaux
...
* 8 entrées d'alarme / 4 sorties d'alarme
...
* Ports de communication: 2 ports USB 2.0, 1 port USB 3.0
