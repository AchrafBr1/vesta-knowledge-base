...
**Étape 1.**Dans le clavier**état d'ouverture inviolable**, placez le clavier dans le**Mode de couplage BLE**en appuyant et en maintenant les deux**＊** key and **0**clé ensemble pour**2 secondes**. Lorsque vous entrez dans le mode de couplage BLE, le clavier émet un long bip et les LED verte et orange s'allument pendant le mode de couplage BLE.
