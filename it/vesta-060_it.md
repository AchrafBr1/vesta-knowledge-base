...
-   ![](<.gitbook/assets/8 (6).png>)Durante il montaggio su una cassetta di sicurezza, montare il contatto porta/sensore d'urto a non più di 2 cm di distanza dal perno della porta (fare riferimento all'immagine seguente).
