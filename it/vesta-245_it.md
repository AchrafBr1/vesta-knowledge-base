...
-   VST-892
-   introduzione
-   Modello: VESTA-245<https://bydemes.com/es/productos/intrusion/alarma-vesta/detectores/VESTA-245>
...
4.  ![](<.gitbook/assets/1 (1) (1) (1) (1).png>)**Interruttore antimanomissione**
5.  **Interruttore ponticello di attivazione/disattivazione dell'immunità agli animali domestici (JP3)**

![jumper open](<.gitbook/assets/2 (1) (1) (1) (1).png>)![jumper close](<.gitbook/assets/3 (1) (1) (1).png>)
...
-   ![](<.gitbook/assets/5 (9).png>)Evitare ostacoli di grandi dimensioni nell'area di rilevamento.
...
1.  Sulla staffa triangolare sono realizzati 4 fori. Per fissare la staffa sul_Muro A_, svolta_Eliminazione A e B_. Per fissare la staffa_Muro B_, svolta_KO C&D_. Per fissare la staffa su entrambi_Muro A e B_, svolta_KO A&D o B&C_.
...
5.  ![triangular bracket](<.gitbook/assets/6 (8).jpeg>)![](<.gitbook/assets/7 (7).png>)Montare la telecamera PIR sui ganci della staffa triangolare.
...
3.  Utilizzare i fori come modello per praticare i fori sulla superficie.
4.  ![](<.gitbook/assets/8 (8).png>)Inserire i tasselli se si fissa su intonaco o mattoni.
5.  Avvitare la base nei tasselli.
6.  Montare il coperchio sulla base e serrare.
