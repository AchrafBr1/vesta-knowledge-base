...
Se il LED lampeggia per indicare la trasmissione del segnale, lampeggerà due volte rapidamente dopo aver ricevuto la conferma dalla centrale._\\_
...
* _**Per iniziare: apprendere la telecamera PIR nel pannello di controllo**_
  ...
  * In base alle tue esigenze, imposta l'interruttore di sensibilità come mostrato in\_Tabella delle posizioni dei DIP switch\_.
...
Per fissare il supporto rotante alla parete sono forniti uno speciale cacciavite con punta a doppia faccia reversibile (come l'immagine sotto a sinistra) e viti a brugola a tre stelle.
