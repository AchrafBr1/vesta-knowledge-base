...
Quando l'interruttore di alimentazione si surriscalda, si spegnerà automaticamente. Quando la temperatura ritorna normale, si accenderà automaticamente per riprendere il normale funzionamento.
