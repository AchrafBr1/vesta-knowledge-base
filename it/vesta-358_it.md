...
* _**Funzione di immunità agli animali domestici**_
  ...
  * La funzione Pet Immunity può essere regolata anche tramite impostazione remota, fare riferimento al\_**Impostazione remota**\_ section below.
* _**Funzione di aumento della sensibilità**_
  ...
  * La funzione Sensibilità può essere regolata anche tramite impostazione remota, fare riferimento a\_**Impostazione remota**\_sezione seguente.
...
* _**Linee guida per l'installazione**_
  ...
  * Quando la copertura del rilevamento risulta soddisfacente, seguire i passaggi descritti in\_**Metodo di montaggio**\_sezione seguente per montare il PIR.
