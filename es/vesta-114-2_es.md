...
Terminal BUS en el Panel de Control. Se pueden conectar hasta cuatro KP-35-Combos\_**Cableado del teclado**\_sección en la página siguiente para más detalles.
...
![](<.gitbook/assets/8 (22).jpeg>)**Caution**
...
* _**Resultado del cambio de modo**_
  *
    ...
    * **Error de operación:Se mostrará "Error de operación" en la pantalla LCD junto con 2 pitidos que indican una operación fallida; por ejemplo, cuando envía la solicitud de cambio de modo desdeBrazo ausente**a**Brazo de inicio**modo.
