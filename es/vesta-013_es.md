...
1.  Retire el aislador de batería del MDC-3.
2.  Coloque el panel de control VESTA en modo de aprendizaje (consulte el manual del panel de control para obtener más detalles).
3.  Presione el botón Aprender/Probar en el MDC-3 para enviar la señal al panel de control.
4.  Si el panel de control recibe correctamente la señal, debería responder (por ejemplo, emitiendo un pitido).
    {% final %}
...
![](<.gitbook/assets/1 (10).jpeg>)El contacto de puerta también es capaz de detectar batería baja. Cuando la batería está baja, se enviará una señal de batería baja al panel de control junto con una transmisión regular. El LED se iluminará cuando el contacto de puerta se active en estado de batería baja.

-   **Cambio de batería**

Debes abrir la tapa para insertar/quitar la batería.
...
-   ![](<.gitbook/assets/7 (2) (1).jpeg>)**Montaje con cinta de velcro:**
...
1.  ![C:\\Users\\C1011\\Desktop\\未命名-3.jpg](<.gitbook/assets/10 (1).jpeg>)Aplique el contacto de la puerta en el velcro del lado del bucle pegado con cinta adhesiva a la pared (**Imágenes 8 y 9.**)
...
-   1.  Usando los agujeros como plantilla, taladre ambos agujeros.
