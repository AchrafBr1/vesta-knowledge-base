...
_**Vista frontal**__**Vista interior**_
...
1.  **Sensor de infrarrojos**
    -   -   El sensor de infrarrojos está destinado a detectar objetos en movimiento.
        ...
        -   Por favor refiérase a_**Cambio de lente**_sección para obtener instrucciones sobre cómo cambiar la lente PIR.
    -   **Lente de cámara PIR**
...
**Paso 6.**Después de cambiar la lente IR, asegúrese de ajustar**Interruptor DIP 3**ajustes para una aplicación adecuada.
