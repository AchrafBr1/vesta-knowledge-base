...
1.  ![](<.gitbook/assets/5 (7) (1).png>)**Compartimiento de la batería**
2.  **Imán**
...
![](<.gitbook/assets/6 (4) (1).jpeg>)**Para el modelo DC-23:**
...
1.  ![](<.gitbook/assets/7 (3) (1).jpeg>)Use su pulgar para presionar el pestillo, mientras lo presiona, extraiga la cubierta de la base del contacto de la puerta (vea la imagen a continuación desde el ángulo de vista superior).
2.  El extremo superior de la caja frontal tiene un orificio de plástico más delgado. Rompe el orificio ciego para crear un orificio para la conexión del cableado al terminal de extensión.
3.  Conecte el dispositivo al terminal de extensión.
