...
Si el LED parpadea para indicar transmisión de señal, parpadeará dos veces rápidamente al recibir el reconocimiento del panel._\\_
...
|   | interruptor2 |   |         |          |                              | EN                                            |                                        | APAGADO      |         | Medio; Mascota de 35 kg (por defecto) |                           |                                                        |                                |                          |         |   |   |   |   |
|   |              |   |         |          |                              |                                               |                                        |              |         |                                       |                           |                                                        |                                |                          |         |   |   |   |   |
...
|   |              |   |         |          | (por defecto)                |                                               |                                        |              |         |                                       |                           |                                                        |                                |                          |         |   |   |   |   |
|   | interruptor4 |   |         |          |                              |                                               |                                        |              |         | APAGADO                               |                           | Desactivación de inmunidad a mascotas (predeterminado) |                                |                          |         |   |   |   |   |
|   |              |   |         |          |                              |                                               |                                        |              |         |                                       |                           |                                                        |                                |                          |         |   |   |   |   |
...
* _**Primeros pasos: aprender a utilizar la cámara PIR en el panel de control**_
  ...
  * Según sus necesidades, configure el interruptor de sensibilidad como se muestra en\_Tabla de posiciones del interruptor DIP\_.
...
* A menos que sea necesario, sugerimos mantener la ubicación de montaje de la cámara PIR a una altura de 2,3 metros para un rendimiento óptimo. Si cambia la altura de montaje, realice una prueba de detección para asegurarse de que la cámara PIR pueda detectar intrusos normalmente a la altura elegida.
