...
-   -   Coloque la puerta de enlace Z-Wave o el panel de control en**Modo de inclusión**(consulte el manual de la puerta de enlace Z-Wave o del panel de control).
    ...
    -   La puerta de enlace incluirá automáticamente el dispositivo al reconocerlo haciendo coincidir la solicitud de inclusión con el DSK obtenido.
        ...
        -   Si el dispositivo ya se ha agregado (incluido) en otra puerta de enlace/panel de control Z-Wave, exclúyalo primero (consulte_**Quitar dispositivo**_) antes de intentar incluirlo en el panel de control/puerta de enlace Z-Wave actual. El dispositivo no enviará un
...
Batería CC (COMANDO_CLASE_BATERÍA)

SensorMutinivel CC, V11 (COMANDO_CLASE_SENSOR_MULTI NIVEL)

Notificación CC,V8 (COMANDO_CLASE_NOTIFICACIÓN)
...
Activación de escena CC (COMANDO_CLASE_ESCENA_ACTIVACIÓN)
...
Por favor refiérase a_Tabla 2_Control de sirena, enviará 00 00 cuando se restablezca el detector de humo.

-   _**Formato de datos de clase de comando**_
    -   **AC Failure/Restore: \[DOMINIO_CLASE_NOTIFICACIÓN]\[NOTIFICACIÓN_INFORME]**
...
-   **Batería:\[DOMINIO_CLASE_BATERÍA]\[BATERÍA_INFORME]**
...
-   **Informe de temperatura/humedad:\[DOMINIO_CLASE_SENSOR_MULTI NIVEL]\[SENSOR_MULTI NIVEL_INFORME]**
...
-   **Prueba de alarma de humo/Prueba de alarma de humo desactivada::\[DOMINIO_CLASE_NOTIFICACIÓN]\[NOTIFICACIÓN_INFORME]**
...
-   **Emergencia por humo/Emergencia por humo eliminada:\[DOMINIO_CLASE_NOTIFICACIÓN]\[NOTIFICACIÓN_INFORME]**
...
-   **Emergencia por calor/Emergencia por calor eliminada:\[DOMINIO_CLASE_NOTIFICACIÓN]\[NOTIFICACIÓN_INFORME]**
...
-   **Emergencia de CO/Emergencia de CO despejada:\[DOMINIO_CLASE_NOTIFICACIÓN]\[NOTIFICACIÓN_INFORME]**
...
-   **Informe de apertura/cierre de manipulación:\[DOMINIO_CLASE_NOTIFICACIÓN]\[NOTIFICACIÓN_INFORME]**
...
|  Cierre por manipulación: | 00 00 00 FF 07 00 01 03 |
| -------------------------- | ----------------------- |
...
-   **Control de escena/sirena:\[DOMINIO_CLASE_ESCENA_ACTIVACIÓN]\[ESCENA_ACTIVACIÓN_SET] (para modelos conectados en serie):**
...
-   **Control de encendido/apagado de sirena:\[DOMINIO_CLASE_BÁSICO]\[BÁSICO_COLOCAR]**
    ...
    -   **Indicador**Control**:\[DOMINIO_CLASE_INDICADOR]\[INDICADOR_COLOCAR]**
...
| - | - | --------- | - | ------------------------------------------------------------------- | ------------------------------- | ------------------ | - | - | - | - | - | - |
|   |   |           |   |                                                                     |                                 |                    |   |   |   |   |   |   |
|   |   |           |   | Clase de comando = COMANDO_CLASE_INDICADOR                          |                                 |                    |   |   |   |   |   |   |
|   |   |           |   |                                                                     |                                 |                    |   |   |   |   |   |   |
|   |   |           |   |                                                                     | Comando = INDICADOR_COLOCAR     |                    |   |   |   |   |   |   |
|   |   |           |   |                                                                     |                                 |                    |   |   |   |   |   |   |
...
|   |                  |   |   |                    |   |                                                 |                  |   |   |
|   |                  |   |   |                    |   |                                                 |                  |   |   |
|   | 0x43             |   |   | BOTÓN 1_INDICACIÓN |   | Úselo para llamar la atención sobre el botón 1. |                  |   |   |
...
|                                                                |   |                  |   |   |                   |                     |                                                   |                  |                                                          |                |   |   |   |
|                                                                |   |                  |   |   |                   |                     |                                                   |                  |                                                          |                |   |   |   |
|                                                                |   | 0x44             |   |   | BOTÓN2_INDICACIÓN |                     | Úselo para llamar la atención sobre el botón 2.   |                  |                                                          |                |   |   |   |
|  ID de propiedad (0x00-0xFE) --- LED encendido_tiempos libres |   |                  |   |   |                   |                     |                                                   |                  |                                                          |                |   |   |   |
|                                                                |   | Valor            |   |   |                   | Descripción general |                                                   |                  |                                                          | Uso específico |   |   |   |
|                                                                |   | 0x04             |   |   |                   | En_Apagado_Ciclos   | Número de encendido_Apagado_Periodo para ejecutar |                  |                                                          |                |   |   |   |
|                                                                |   |                  |   |   |                   |                     |                                                   |                  | 0x00 – 0xFE = 0-254 veces                                |                |   |   |   |
|                                                                |   |                  |   |   |                   |                     |                                                   |                  | 0xFF = Ejecutar hasta que se detenga mediante On_Apagado |                |   |   |   |
|                                                                |   |                  |   |   |                   |                     |                                                   |                  |                                                          |                |   |   |   |
...
**Configuraciones:\[DOMINIO_CLASE_CONFIGURACIÓN]\[CONFIGURACIÓN_COLOCAR]**
...
|                                                  |                                    |
| 0x06, Ubicación                                  | 0~20                               |
| (por favor refiérase a_Tabla 3_)                 |                                    |
|                                                  |                                    |
...
\[DOMINIO_CLASE_DISPOSITIVO_REINICIAR_EN LA ZONA]\[DISPOSITIVO_REINICIAR_EN LA ZONA_NOTIFICACIÓN]
