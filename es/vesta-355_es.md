...
Conecte los cuatro terminales (VCC, GND, A, B) al terminal BUS en el panel de control. Por favor refiérase a\_**Cableado de la cámara PIR**\_sección para más detalles.
