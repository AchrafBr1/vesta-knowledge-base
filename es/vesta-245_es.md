...
-   VST-892
-   Introducción
-   Model: VESTA-245<https://bydemes.com/es/productos/intrusion/alarma-vesta/detectores/VESTA-245>
...
4.  ![](<.gitbook/assets/1 (1) (1) (1) (1).png>)**Manibela de encendido**
...
-   ![](<.gitbook/assets/5 (9).png>)Evite grandes obstáculos en el área de detección.
...
5.  ![triangular bracket](<.gitbook/assets/6 (8).jpeg>)![](<.gitbook/assets/7 (7).png>)Coloque la cámara PIR en los ganchos del soporte triangular.
...
3.  Utilice los agujeros como plantilla para perforar agujeros en la superficie.
4.  ![](<.gitbook/assets/8 (8).png>)Inserte los tacos si lo fija en yeso o ladrillo.
5.  Atornille la base a los tacos de pared.
6.  Coloque la cubierta en la base y apriete.
