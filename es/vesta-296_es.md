...
*
  ...
  2. Cuando se completen todas las acciones, el control del obturador enviará un MULTINIVEL\_INFORME: 0x63 al controlador indicando que la posición actual está en la parte superior. El LED se apagará cuando el motor del obturador salga del modo de calibración automática.
