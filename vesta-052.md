...
* ![Mini-PIR B 2](<.gitbook/assets/0 (21).jpeg>)1. IR Lens w/ LED Indicator
...
* Press the button once within 30 seconds of inserting the battery to enter Inclusion or\
  Exclusion mode.
* Press the button once in normal operation to send a wake up notification command\
  and enter Test Mode.
...
![](<.gitbook/assets/1 (30).png>)![](<.gitbook/assets/2 (33).png>)
...
* Installation
* _Mounting Height and PIR Detection Coverage_
...
![Mini-PIR B](<.gitbook/assets/3 (14).jpeg>)
...
| ------ | --------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1      | Lifeline  | 5              | <p>Supports the following command classes: </p><ul><li>Device Reset Locally: triggered upon reset</li><li>Notification Report: triggered by PIR</li><li>Battery Report: when battery level changes</li></ul> |
| 2      | Basic Set | 5              | <p>When PIR triggers, group 2 sends 0xFF.</p><p>When PIR restores, group 2 sends 0x00.</p>                                                                                                                   |

**Command Class Configuration:**

| **Number** | **Name**        | **Size** | **Minimum** | **Maximum** | **Default** | **Description**                                                                                                                                                                                                                                           |
| ---------- | --------------- | -------- | ----------- | ----------- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1          | IR Sensitivity  | 1        | 1           | 5           | 4           | <p>Sensitivity level adjustment:</p><ul><li>1: the lowest; 5: the highest</li><li>When the maximum is larger than 5, 5 will be the set value; when the minimum is smaller than 1, 1 will be the set value.</li></ul>                                      |
| 2          | IR Restore Time | 1        | 1           | 120         | 1           | <p>The timer length is adjustable from 30 seconds to 60 minutes:</p><ul><li>1: 30 seconds; 120: 60 minutes</li><li>When the maximum is larger than 120, 120 will be the set value; when the minimum is smaller than 1, 1 will be the set value.</li></ul> |
