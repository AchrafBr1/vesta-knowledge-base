...
*
  1. **Tamper**
  2. **Battery**
  3. **Infrared Detection Area**
  4. **Reflecting Sticker**
* _**LED Indicator**_
...
![](<.gitbook/assets/3 (12).jpeg>) ![](<.gitbook/assets/4 (12).jpeg>) ![](<.gitbook/assets/5 (8).jpeg>)
...
![](<.gitbook/assets/6 (12).jpeg>)

* _**Changing Battery**_

Use a flat-headed screwdriver to fit into the cover opening hole at the bottom. Gently push the flat-headed screwdriver upwards and remove the top cover. Remove the old battery as shown in Figure 1, and then press the Learn / Test button 5-6 times to fully discharge. Insert a new battery and replace the cover, as shown in Figure 2.

1

Figure 1 Figure 2

![](<.gitbook/assets/7 (11).jpeg>) ![](<.gitbook/assets/8 (11).png>) ![](<.gitbook/assets/9 (12).png>)
...
Find a suitable place to install the Door Contact. Please make sure the location is within signal range of the Control Panel before mounting.

* The mounting surface should be clean, dry, and smooth. Clean the mounting surface with a suitable degreaser if needed.
* The reflecting sticker has to be applied on the **opposite** side of the Infrared Detection Area of OPDC-1. The gap should be no more than **3mm** when the door/window is closed.

Step 1: Remove the protective covering from one side of the provided double-sided adhesive pad. Apply to the back of the Optical Door Contact and press firmly for 30 seconds to ensure good contact.

Step 2: Remove the other cover and firmly press the Optical Door Contact onto the desired location.

![](<.gitbook/assets/13 (5).jpeg>)

Step 3: Apply the reflecting sticker.
...
* Please note the 3M adhesive tape cannot be reused. Please avoid re-applying it.
