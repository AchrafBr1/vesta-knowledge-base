...
* To exit Test mode, press ![](<.gitbook/assets/5 (5).png>) **twice**, Keypad will sound a long beep and the Green Active LED will turn on, then Keypad returns to Normal Operation mode.
  ...
  *
    *
      *
        ...
        * Quit Test Mode —press ![](<.gitbook/assets/6 (1).png>) **twice**.
...
Step 6. Press ![](<.gitbook/assets/7 (2).png>) **twice** to exit Test mode and the installation is completed.
