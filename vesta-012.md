...
a label. If disarm is successful, the ![](<.gitbook/assets/23 (1).png>) LED will turn ON along with 2 beeps. If there is **Alarm Memory,** the ![](<.gitbook/assets/24 (1).png>) LED and fault LED will turn ON along with 5 beeps.
