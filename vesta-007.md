...
* ![852Pro R8\_20160629](<.gitbook/assets/0 (8).jpeg>)Parts Identification
...
* ![852 r3 knockouts](<.gitbook/assets/6 (2) (1).jpeg>)_Mounting the PIR Camera_
...
1. ![triangular bracket](<.gitbook/assets/7 (8).jpeg>)![triangular bracket](<.gitbook/assets/8 (7).jpeg>)Open the cover by loosening the Cover Screw using a Philips screwdriver.
