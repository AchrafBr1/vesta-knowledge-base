...
* ![852Pro R8\_20160629](<.gitbook/assets/0 (1).jpeg>)Parts Identification
...
* ![852 r3 knockouts](<.gitbook/assets/6 (3).jpeg>)_Mounting the PIR Camera_
...
1. ![triangular bracket](<.gitbook/assets/7 (1).jpeg>)![triangular bracket](<.gitbook/assets/8 (1).jpeg>)Open the cover by loosening the Cover Screw using a Philips screwdriver.
