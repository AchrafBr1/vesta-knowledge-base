...
| ------------------------------------------------------------------ | ------------------------------------------------------------------------------------- |
| <img src=".gitbook/assets/1 (39).png" alt="" data-size="original"> | <img src=".gitbook/assets/image (4) (1) (1) (1) (1).png" alt="" data-size="original"> |
...
| **Control Panel webpage**                                           | **SmartHomeSec**                                                                  |
| ------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| <img src=".gitbook/assets/11 (15).png" alt="" data-size="original"> | <img src=".gitbook/assets/image (4) (1) (1) (1).png" alt="" data-size="original"> |
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| <img src=".gitbook/assets/13 (16).png" alt="" data-size="original"> | <img src=".gitbook/assets/image (1) (1) (1) (1) (1).png" alt="" data-size="original"> |
