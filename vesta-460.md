...
<img src=".gitbook/assets/image (2).png" alt="" data-size="line"> If a connection is established, the Green LED will flash rapidly during data transmission via Wi-Fi, and the message “HALOW OK” will appear on the Panel’s webpage upon completing data transmission.

<img src=".gitbook/assets/image (3).png" alt="" data-size="line"> If the connection fails, the Green LED will turn off.
