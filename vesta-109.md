...
1.1. Parts Identification 3

1.2. The Power Supply 3

1.3. LED Indicator 4

1.4. Equipment required 4
...
2.1. Web Browser Access 9

2.2. Smartphone Access 10

2.3. Doorbell Notification 12

2.4. Video / Picture Capture and Event History 13

3\. Remote Programming 14

3.1. App User Setting 14

3.2. Account User Info 15

3.3. Video Setting 15

3.4. VDP Setting 18

### Introduction <a href="#_toc51257981" id="_toc51257981"></a>
...
### Application Overview <a href="#_toc51257982" id="_toc51257982"></a>

### Parts Identification <a href="#_toc51257983" id="_toc51257983"></a>
...
1. **12\~24V DC or 16\~24V AC Power Input**
...
### The Power Supply <a href="#_toc51257984" id="_toc51257984"></a>
...
### LED Indicator <a href="#_toc51257985" id="_toc51257985"></a>

The Video Door Phone has built-in Blue and Red LEDs to indicate device status.

| LED Color                     | Behavior                                            | Indication                                                   |
| ----------------------------- | --------------------------------------------------- | ------------------------------------------------------------ |
| Blue                          | Flash every 3 seconds                               | VDP under Wi-Fi setup mode (AP mode)                         |
| Spinning                      | VDP button pressed, waiting for answer              |                                                              |
| ON                            | VDP under video streaming and two-way communication |                                                              |
| Amber                         | ON for 3 seconds                                    | VDP finish warm up upon power on, entering normal operation. |
| Flash every 3 seconds         | Wi-Fi connectivity problem**\***                    |                                                              |
| Flash every second            | VDP unable to connect to server                     |                                                              |
| 3 Flash then ON for 6 seconds | VDP reset to factory default                        |                                                              |
...
### Equipment required <a href="#_toc51257986" id="_toc51257986"></a>
...
### Hardware Installation <a href="#_toc169331962" id="_toc169331962"></a>
...
### Setup <a href="#_toc51257988" id="_toc51257988"></a>
...
![](<.gitbook/assets/5 (6).jpeg>) ![](<.gitbook/assets/6 (9).jpeg>)
...
1. Select the route to set up your Wi-Fi network and follow on-screen instructions. Please note if the VDP has already been set up to another Wi-Fi network, be sure to reset the device first before adding it into your existing alarm system.
...
![](<.gitbook/assets/7 (8).png>) ![](<.gitbook/assets/8 (8).png>) ![](<.gitbook/assets/9 (8).png>) ![](<.gitbook/assets/10 (3).png>) ![](<.gitbook/assets/11 (2).png>) ![](<.gitbook/assets/12 (3).png>)
...
![](<.gitbook/assets/14 (2).jpeg>) ![](<.gitbook/assets/15 (3).png>) ![](<.gitbook/assets/16 (3).png>)

### Operation <a href="#_toc51257989" id="_toc51257989"></a>
...
### Web Browser Access <a href="#_toc51257990" id="_toc51257990"></a>
...
### Smartphone Access <a href="#_toc51257991" id="_toc51257991"></a>

Use **Vesta Home 5** app to log into Home Portal Account registered by Control Panel. Select Cam page to display VDP streaming thumbnail. Press the thumbnail image to enlarge to full screen.
...
To access camera function setup, tap the ![](.gitbook/assets/21.png) icon and follow below instructions.
...
![Setting](.gitbook/assets/22.png)**To add a new device, tap the icon on the top left corner to setup WiFi for your IP Cam or VDP. Before you proceed, ensure to update device firmware to the latest version.**

**To setup WiFi function for existing model, tap the** **icon and follow the step-by-step instructions.**

**To enlarge to full screen view, tap the** **icon for different function settings. The left-hand menu allows you to switch on or off your microphone, record a video or take a snapshot, or remotely unlock your electric door lock that is bound with the system. Tap the  icon to return to the main page.**

### Doorbell Notification <a href="#_toc51257992" id="_toc51257992"></a>
...
### Video / Picture Capture and Event History <a href="#_toc51257993" id="_toc51257993"></a>
...
* Press the camera icon  on the left-hand menu of the application to take a snapshot.
...
### App User Setting <a href="#_toc51257995" id="_toc51257995"></a>

The account setting page can be accessed by pressing the  icon at top right corner.
...
### Account User Info <a href="#_toc51257996" id="_toc51257996"></a>
...
### Video Setting <a href="#_toc51257997" id="_toc51257997"></a>
...
Click  icon to adjust video settings. Video Adjustment now allows for top/bottom flip video option, thus enabling users to flip video without needing to physically move the Security Camera itself.
...
Click  icon to record a video clip. The IP Camera will record video clip according to its internal setting (Please refer to **3.4. VDP Setting** for detail).

### VDP Setting <a href="#_toc51257998" id="_toc51257998"></a>
