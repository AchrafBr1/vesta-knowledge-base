...
1. **Rechargeable Battery Pack (For WEPC-1B only)**
2. **DC Jack**
...
2. **Dry Contact Relay PGM Output Terminal**
3. **Tamper Switch (For Case Cover)**
...
![](<.gitbook/assets/6 (8).jpeg>) ![](<.gitbook/assets/7 (8).jpeg>)
