...
**A.** ![](<.gitbook/assets/2 (66).jpeg>) **ON** when device is already learned into Zig-Bee network.

**B.** <img src=".gitbook/assets/image (444).png" alt="" data-size="line">**Low Battery Indicator.**

**C**. &#x20;

<img src=".gitbook/assets/4 (60).jpeg" alt="" data-size="line"> On: Device set to default temperature 17°C.

![](<.gitbook/assets/5 (48).jpeg>)   Flash: Valve closing.

![](<.gitbook/assets/6 (59).jpeg>)  On: Device set to default temperature 21°C.

![](<.gitbook/assets/7 (54).jpeg>)  Flash: Valve opening.

**D. Auto / Manual Mode.**

**E.** <img src=".gitbook/assets/image (445).png" alt="" data-size="line">**Boost function.**

**F.** <img src=".gitbook/assets/image (446).png" alt="" data-size="line"> **Open Window**.
...
3. **Function Buttons**
   ...
   3. &#x20;![](<.gitbook/assets/9 (32).jpeg>) Press this button to instantly switch day and night temperatures.                                     _**Default day**_ ![](<.gitbook/assets/10 (24).jpeg>) _temperature: 21_ °&#x43;_, **Default night**_ ![](<.gitbook/assets/11 (31).jpeg>) _temperature: 17_°C
...
* ![](<.gitbook/assets/13 (27).jpeg>) button: switch day/night temperatures instantly.
...
4. When the motor stops working and <img src=".gitbook/assets/image (452).png" alt="" data-size="line"> icon changes to steady on, attach the Valve cap to the pipe.

<figure><img src=".gitbook/assets/image (453).png" alt="" width="404"><figcaption></figcaption></figure>

5. Rotating the Valve cap clockwise to tighten the Radiator Valve.

<figure><img src=".gitbook/assets/image (454).png" alt=""><figcaption></figcaption></figure>

6. Press the Auto/Manual button, LCD displays **AdA** and valve motor starts working again, the ![](<.gitbook/assets/image (455).png>)  icon will flash. The device motor is measuring the distance to adjust the current temperature.
...
8. After joining ZigBee network and completing installation, the ZigBee connection <img src=".gitbook/assets/image (456).png" alt="" data-size="line"> icon  will appear on LCD display.
