...
*
  *
    ...
    * When the jumper is set as OFF, Supervision is enabled. **(Factory default for 868WF model)** _(**868FM** & **869FM** & **F1** models **DO NOT** have JP2, supervision is always enabled)._
...
![](<.gitbook/assets/5 (39).png>) ![](<.gitbook/assets/6 (25).png>)
...
* ![](<.gitbook/assets/12 (12).jpeg>)_**Getting Started**_
...
![](<.gitbook/assets/13 (13).jpeg>) ![](<.gitbook/assets/14 (14).jpeg>)
...
![](<.gitbook/assets/20 (6).jpeg>)

* Avoid reflecting surface in the detection area. Reflected infrared signatures may lead to false alarm.
