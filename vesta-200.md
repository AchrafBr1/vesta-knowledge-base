...
**Door Contact (DC-15SL-2W-F1) User Manual**
...
*
  1. **Internal Magnetic Switch Jumper Switch (JP3)**
...
(i) Use the 2 Magnet Screw holes as a template for appropriate hole positioning.
...
2. Insert the two white caps into the magnet screw holes for aesthetic integrity. Step 5: Installation is now complete.
