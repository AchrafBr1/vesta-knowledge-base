...
![](<.gitbook/assets/0 (7).png>)**WIRED/WIRELESS COMBO KEYPAD with NFC READER (KPT-35N-Combo-BYD)**
...
5. **Backlit Star (＊) Key**
6. **Cover Case**
7. **Backlit Restore (**![](<.gitbook/assets/2 (8).jpeg>)) **Key**
   *
...
Please check whether KPT-35N-Combo-BYD is connected properly to the Panel within proper wiring distance.
