...
![](<.gitbook/assets/0 (16).png>)IRP-29SL / IRP-29SL-F1 – Pet Immune PIR sensor with lithium battery
...
* ![](<.gitbook/assets/3 (15).png>)The base has knockouts, where the plastic is thinner and can be broken for mounting purpose. Two knockouts are for surface fixing and four knockouts are for corner fixing as shown in the picture.
...
5. ![](<.gitbook/assets/4 (16).png>)Screw the cover onto the base.
...
2. ![](<.gitbook/assets/5 (17).png>)Break through the knockouts on the inside of base
