...
![](<.gitbook/assets/2 (89).jpeg>) If the jumper is ON (the jumper link rests on both pins), the communication ability is enhanced.

1. **Mounting Holes**
2. **AC Power Terminal and Power Cable**
...
1. **Tamper Switch Terminal Block 1**

For connecting to the door tamper switch on the enclosure

1. **Tamper Switch Terminal Block 2 (optional)**
