...
| ON                                              | Enable (Default)                                                              |
| OFF                                             | Disable                                                                       |
| <mark style="background-color:blue;">SW2</mark> | <mark style="background-color:blue;">Terminal 1 Type = IR</mark>              |
| ON                                              | Enable                                                                        |
| OFF                                             | Disable (Default)                                                             |
| <mark style="background-color:blue;">SW3</mark> | <mark style="background-color:blue;">Terminal 1 Type = Smoke Detector</mark>  |
| ON                                              | Enable                                                                        |
| OFF                                             | Disable (Default)                                                             |
| <mark style="background-color:blue;">SW4</mark> | <mark style="background-color:blue;">Terminal 1 Type = Panic Button</mark>    |
| ON                                              | Enable                                                                        |
| OFF                                             | Disable (Default)                                                             |

| <mark style="background-color:blue;">SW5</mark> | <mark style="background-color:blue;">Supervision</mark>                    |
| ----------------------------------------------- | -------------------------------------------------------------------------- |
| ON                                              | Enable (Default)                                                           |
| OFF                                             | Disable                                                                    |
| <mark style="background-color:blue;">SW6</mark> | <mark style="background-color:blue;">CON4 NO/NC</mark>                     |
| ON                                              | Normal open                                                                |
| OFF                                             | Normal close (Default)                                                     |
| <mark style="background-color:blue;">SW7</mark> | <mark style="background-color:blue;">Roller shutter Activation</mark>      |
| ON                                              | 8 pulse / 10sec                                                            |
| OFF                                             | 5 pulse / 10sec (Default)                                                  |
| <mark style="background-color:blue;">SW8</mark> | <mark style="background-color:blue;">Terminal 1 Type = Gas Detector</mark> |
| ON                                              | Enable                                                                     |
| OFF                                             | Disable (Default)                                                          |
