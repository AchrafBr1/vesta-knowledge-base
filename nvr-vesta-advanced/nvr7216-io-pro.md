...
## 16-channel Ultra AI Series IP NVR

<figure><img src="../.gitbook/assets/image (1214).png" alt="" width="375"><figcaption><p>NVR7216-IO-PRO</p></figcaption></figure>
...
* Manual, scheduled recording modes (general, video sensor, alarm, intelligence)
...
* Artificial Intelligence in the recorder:
  ...
  * Face recognition: Up to 2 channels (20 face databases with a total of 100,000 faces)
  * Intelligent motion detection: Up to 8 channels
...
* Internal capacity for 2 SATA HDD up to 16TB (sold separately)
* eSATA port
...
* Communication ports: 4 USB 2.0 ports, 1 USB 3.0 port, 1 RS232 port and 1 RS485 port
* Power supply: 12V DC, 3 A
