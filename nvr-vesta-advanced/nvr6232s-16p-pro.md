...
## 32-channel Pro AI-L Series NVR with 16 PoE

<figure><img src="../.gitbook/assets/image (1214).png" alt="" width="375"><figcaption><p>NVR6232S-16P-PRO</p></figcaption></figure>
...
* Bandwidth: 256 Mbps in, 256 Mbps out
* Decoding capacity:
  * 4 channels at 8MP (30 fps)
  * 16 channels 1080P (30 fps)
* Supports adaptive decoding
* Manual, scheduled recording modes (general, videosensor, alarm, intelligence)
* Alarm link: Recording, Image capture, Buzzer, Logging, Preset, Email
...
* Artificial Intelligence in the recorder:
  * Perimeter protection (intrusion, line crossing): Up to 2 channels
  * Face detection: Up to 2 channels
  * Intelligent motion detection: Up to 2 channels
...
* Internal capacity for 2 SATA HDDs up to 14TB (sold separately)
* 16 PoE (802.3af) 10/100Mbps ports
* Gigabit Ethernet RJ45 network port (10/100/1000Mbps)
