...
The three![](<.gitbook/assets/1 (7).png>)![](<.gitbook/assets/2 (7).png>)![](<.gitbook/assets/3 (7).png>) LEDs will turn on along with a long beep.
...
1. Press ＊ key and then 9 key — Enable Arm/ Home with Control Panel User PIN Code function (Default).
...
Step 6. Press ![](<.gitbook/assets/4 (7).png>) key to exit NFC label learning mode.
...
![NFC iPhone3](<.gitbook/assets/5 (7).jpeg>)Step 5. Press ![](<.gitbook/assets/6 (2) (1).png>) key to exit NFC label learning mode.
...
NFC label. If panel has no fault and arming is successful, the ![](<.gitbook/assets/9 (2) (1).png>) LED will turn ON along with
...
a label. If disarm is successful, the ![](.gitbook/assets/23.png) LED will turn ON along with 2 beeps. If there is **Alarm Memory,** the ![](.gitbook/assets/24.png) LED and fault LED will turn ON along with 5 beeps.
...
*
  ...
  2. When the Keypad disarms the panel, the ![](.gitbook/assets/25.png) LED will turn ON along with two beeps indicating normal operation.
