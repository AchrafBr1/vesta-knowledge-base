...
![NFC iPhone3](.gitbook/assets/5.jpeg)Step 5. Press ![](<.gitbook/assets/6 (2).png>) key to exit NFC label learning mode.
...
NFC label. If panel has no fault and arming is successful, the ![](<.gitbook/assets/9 (2).png>) LED will turn ON along with
