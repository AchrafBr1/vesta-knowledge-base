...
{% hint style="danger" %}
**Note: Wait  2 minutes to allow the device to exchange all the necessary data with the control unit before testing begins.**
{% endhint %}
...
2. Toggle from Unlock ![](<.gitbook/assets/Unknown image (231)>) to Lock ![](<.gitbook/assets/Unknown image (232)>). Door is locked.
